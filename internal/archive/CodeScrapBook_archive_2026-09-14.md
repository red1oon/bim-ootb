# CodeScrapBook — archive (closed sections)

> Moved out of `internal/CodeScrapBook.md` on 2026-09-14 to keep the live file short.
> These are finished arguments and one-off analyses — correct as measured, but nothing
> in them is waiting on a decision. The live file keeps orientation, the open register,
> and the re-measure commands. Figures here were measured at `719ebb92` unless stated.
