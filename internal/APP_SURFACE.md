...
|---|---:|
| files scanned | 1669 |
| distinct fields | 1098 |
| written only as `A.x`/`app.x` (invisible to an `APP.` grep) | 979 |
| read but never written (phantom) | 60 |
...
| `APP._applyPendingPatch` | `viewer/streaming.js:3059` | **yes** |
| `APP._billboardImage` | `viewer/effects.js:2347` | **yes** |
| `APP._bomDb` | `viewer/doc_canvas.js:512` | **yes** |
| `APP._buildPill` | `viewer/panels.js:1016` | **yes** |
| `APP._cinemaOrbitActive` | `viewer/dlod_nav.js:400` | **yes** |
| `APP._cpeViewfinderRender` | `viewer/main.js:740` | **yes** |
| `APP._debugForceGhostLensOwned` | `witness_bbox_ghost_stuck.js:65` | no |
| `APP._debugGhostLensOwned` | `witness_bbox_ghost_stuck.js:65` | no |
...
| `APP._jsonRegistry` | `viewer/measure.js:930` | **yes** |
...
| `APP._openJsonEditor` | `viewer/measure.js:931` | **yes** |
| `APP._photoDuskMood` | `viewer/effects.js:3714` | **yes** |
| `APP._photoFacadeLightsDbg` | `probe_facade_warm_cool.js:56` | no |
| `APP._probeAimDepth` | `witness_cpe_aim_retire.js:355` | no |
| `APP._rangeDb` | `viewer/clash_narrow.js:379` | **yes** |
| `APP._refreshGroundBtns` | `viewer/tools.js:227` | **yes** |
| `APP._runSqlChunked` | `viewer/navigate_find.js:1029` | **yes** |
| `APP._setTreeMode` | `witness_bbox_ghost_stuck.js:65` | no |
...
| `APP.clearRouteCache` | `viewer/navigate_find.js:4245` | **yes** |
| `APP.closeSunglass` | `viewer/main.js:292` | **yes** |
| `APP.composeGhostsFromAggregates` | `viewer/streaming.js:3073` | **yes** |
...
| `APP.materializeZones` | `optics_hud.js:34` | **yes** |
...
| `APP.runPanelAction` | `viewer/main.js:1197` | **yes** |
...
| `APP.stopNavigation` | `viewer/navigate_find.js:4233` | **yes** |
| `APP.toast` | `viewer/dlod_nav.js:2005` | **yes** |
| `APP.toggleGridOverlay` | `tests/specs/28-grid-overlay-init.spec.js:25` | **yes** |
...
| `APP.DB_URL` | `erp/kanban_lens.html:243` | 2 | 52 |
| `APP.DEFAULT_COLOR` | `viewer/config.js:49` *(as `A.`)* | 1 | 7 |
| `APP.DISC_COLORS` | `viewer/config.js:43` *(as `A.`)* | 1 | 31 |
| `APP.EMBEDDED` | `viewer/config.js:34` *(as `A.`)* | 1 | 3 |
| `APP.FIND_GUID` | `viewer/config.js:40` *(as `A.`)* | 1 | 9 |
...
| `APP.MATERIAL_COSTS` | `viewer/config.js:52` *(as `A.`)* | 1 | 4 |
| `APP.MEP_HUE_ACHROMATIC_MAX` | `viewer/streaming.js:670` *(as `A.`)* | 1 | 8 |
| `APP.PAN_SPEED` | `viewer/config.js:83` *(as `A.`)* | 1 | 2 |
| `APP.PHASE_MAP` | `viewer/config.js:74` *(as `A.`)* | 1 | 4 |
| `APP.PROD_BASE` | `viewer/config.js:21` *(as `A.`)* | 1 | 8 |
...
| `APP._applyDiscVisibility` | `viewer/panels.js:821` *(as `A.`)* | 1 | 5 |
| `APP._applyGroundTexture` | `viewer/tools.js:215` *(as `A.`)* | 1 | 7 |
| `APP._applyNightGlowToMatCache` | `viewer/tools.js:1232` *(as `A.`)* | 1 | 4 |
| `APP._applyPendingPatch` | — *phantom* | 0 | 4 |
...
| `APP._batchMeta` | `viewer/streaming.js:2004` *(as `A.`)* | 1 | 119 |
| `APP._batchStoreyMap` | `viewer/streaming.js:2005` *(as `A.`)* | 2 | 9 |
| `APP._bboxCleared` | `viewer/streaming.js:395` *(as `A.`)* | 5 | 9 |
| `APP._bboxMaterial` | `viewer/helpers.js:535` *(as `A.`)* | 1 | 5 |
...
| `APP._billboardImage` | — *phantom* | 0 | 4 |
...
| `APP._bloomOff` | `viewer/effects.js:5167` *(as `A.`)* | 1 | 3 |
...
| `APP._buildPill` | — *phantom* | 0 | 4 |
| `APP._buildSunglassPanel` | `viewer/panels.js:312` *(as `A.`)* | 1 | 2 |
| `APP._buildTourInner` | `viewer/tour.js:822` *(as `A.`)* | 1 | 2 |
| `APP._buildingCol` | `viewer/scene.js:1015` *(as `A.`)* | 4 | 8 |
| `APP._bvhPending` | `viewer/streaming.js:1765` *(as `A.`)* | 3 | 13 |
...
| `APP._camLight` | `viewer/effects.js:3844` *(as `A.`)* | 1 | 17 |
...
| `APP._cinemaPathEdit` | `viewer/effects.js:9179` *(as `A.`)* | 24 | 38 |
...
| `APP._cityElemBudget` | `viewer/city.js:87` *(as `A.`)* | 1 | 3 |
...
| `APP._cityRayBlast` | `viewer/city.js:915` *(as `A.`)* | 1 | 2 |
...
| `APP._composer` | `viewer/effects.js:10` *(as `A.`)* | 3 | 77 |
| `APP._composerEnabled` | `viewer/effects.js:13` *(as `A.`)* | 10 | 15 |
| `APP._compositePhoto` | `viewer/sitecam.js:247` *(as `A.`)* | 1 | 4 |
...
| `APP._cpeAimFreezeOff` | `witness_cpe_corr_brush.js:152` *(as `A.`)* | 6 | 7 |
| `APP._cpeBeat3GazeDebug` | `viewer/effects.js:7274` *(as `A.`)* | 1 | 10 |
| `APP._cpeBeat3PoseDebug` | `viewer/effects.js:7265` *(as `A.`)* | 1 | 2 |
| `APP._cpeCorrBranchOff` | `witness_cpe_aim_retire.js:322` *(as `A.`)* | 4 | 5 |
| `APP._cpeCorrectionsDebug` | `viewer/effects.js:7259` *(as `A.`)* | 1 | 7 |
| `APP._cpeGazeClearDebug` | `viewer/effects.js:7291` *(as `A.`)* | 1 | 8 |
| `APP._cpePinZonesDebug` | `viewer/effects.js:7011` *(as `A.`)* | 1 | 6 |
| `APP._cpeRevealLightsOff` | `viewer/cinema_maxq.js:1832` *(as `A.`)* | 1 | 7 |
...
| `APP._cpeViewfinderRender` | — *phantom* | 0 | 8 |
| `APP._createIsSOTrx` | `erp/idempiere.html:3637` | 1 | 1 |
| `APP._createMovementType` | `erp/idempiere.html:3645` | 1 | 1 |
...
| `APP._currentClashes` | `viewer/clash_matrix.js:315` *(as `A.`)* | 10 | 43 |
| `APP._dbPersistUrl` | `viewer/streaming.js:3084` *(as `A.`)* | 2 | 11 |
| `APP._debugForceGhostLensOwned` | — *phantom* | 0 | 6 |
| `APP._debugGhostLensOwned` | — *phantom* | 0 | 3 |
| `APP._deepLinkCamOverride` | `viewer/issues.js:182` *(as `A.`)* | 3 | 5 |
| `APP._diffToVoRows` | `viewer/diff.js:350` *(as `A.`)* | 1 | 2 |
...
| `APP._dlodFrame` | `viewer/dlod.js:15` *(as `A.`)* | 9 | 11 |
...
| `APP._doReportBug` | `viewer/helpers.js:241` *(as `A.`)* | 1 | 6 |
...
| `APP._emberEnabled` | `viewer/effects.js:4569` *(as `A.`)* | 1 | 3 |
| `APP._ensureClashIndexes` | `viewer/measure.js:107` *(as `A.`)* | 1 | 7 |
| `APP._ensureRoomsInflight` | `viewer/navigate_find.js:939` *(as `A.`)* | 2 | 8 |
| `APP._enterClashMode` | `viewer/measure.js:1693` *(as `A.`)* | 1 | 2 |
| `APP._entourageVariant` | `viewer/streaming.js:581` *(as `A.`)* | 1 | 6 |
| `APP._envCache` | — *phantom* | 0 | 2 |
| `APP._envMap` | `viewer/effects.js:3533` *(as `A.`)* | 4 | 30 |
| `APP._envMapHdriActive` | `viewer/effects.js:3696` *(as `A.`)* | 2 | 5 |
| `APP._envMapThrottle` | `viewer/scene.js:297` *(as `A.`)* | 2 | 4 |
| `APP._envmapStompStats` | `viewer/scene.js:214` *(as `A.`)* | 1 | 1 |
| `APP._evictOldest` | `viewer/scene.js:621` *(as `A.`)* | 1 | 3 |
| `APP._exitClashMode` | `viewer/measure.js:1784` *(as `A.`)* | 1 | 8 |
| `APP._exportBuildingDb` | `viewer/scene.js:805` *(as `A.`)* | 1 | 17 |
...
| `APP._facadeWarmCool` | `viewer/effects.js:368` *(as `A.`)* | 3 | 4 |
...
| `APP._flyToClash` | `viewer/measure.js:621` *(as `A.`)* | 1 | 10 |
...
| `APP._getCinemaPathEdit` | `viewer/effects.js:9213` *(as `A.`)* | 1 | 23 |
| `APP._getImport` | `viewer/import.js:601` *(as `A.`)* | 1 | 7 |
| `APP._getMarkupBlob` | `viewer/sitecam.js:442` *(as `A.`)* | 1 | 6 |
| `APP._getMaterial` | `viewer/streaming.js:907` *(as `A.`)* | 1 | 15 |
| `APP._getPhotoSkyline` | `viewer/effects.js:4535` *(as `A.`)* | 1 | 3 |
| `APP._getPhotoSparkles` | `viewer/effects.js:4534` *(as `A.`)* | 1 | 1 |
| `APP._getStaffageInstances` | `viewer/effects.js:1785` *(as `A.`)* | 1 | 9 |
...
| `APP._groundCfgDefault` | `viewer/tools.js:107` *(as `A.`)* | 1 | 3 |
| `APP._groundConfig` | `viewer/tools.js:116` *(as `A.`)* | 3 | 7 |
...
| `APP._groundWetnessOverride` | `viewer/effects.js:3393` *(as `A.`)* | 2 | 9 |
| `APP._groupBy` | `viewer/tools.js:624` *(as `A.`)* | 1 | 17 |
| `APP._guidToMesh` | `viewer/measure.js:1237` *(as `A.`)* | 1 | 1 |
| `APP._hasBbox` | `viewer/streaming.js:345` *(as `A.`)* | 6 | 21 |
| `APP._hasBuildingCol` | `viewer/streaming.js:258` *(as `A.`)* | 1 | 12 |
| `APP._hasMatNameCol` | `viewer/streaming.js:289` *(as `A.`)* | 1 | 2 |
| `APP._hasMultiDraw` | `viewer/scene.js:59` *(as `A.`)* | 2 | 4 |
| `APP._hbaAttendanceLog` | `viewer/hba_lens.js:262` *(as `A.`)* | 1 | 14 |
| `APP._hbaAttendanceSpec` | `viewer/hba_lens.js:387` *(as `A.`)* | 1 | 11 |
| `APP._hbaBomSpec` | `viewer/hba_lens.js:395` *(as `A.`)* | 1 | 6 |
| `APP._hbaClassFilter` | — *phantom* | 0 | 1 |
| `APP._hbaEmpResourceMap` | `viewer/hba_lens.js:386` *(as `A.`)* | 1 | 4 |
| `APP._hbaLeaveSpec` | `viewer/hba_lens.js:291` *(as `A.`)* | 1 | 3 |
| `APP._hbaOccupancyLog` | `viewer/hba_lens.js:255` *(as `A.`)* | 1 | 9 |
| `APP._hbaPayrollSpec` | `viewer/hba_lens.js:281` *(as `A.`)* | 2 | 8 |
| `APP._hbaPeriod` | — *phantom* | 0 | 5 |
| `APP._hbaRequestLog` | `viewer/hba_lens.js:273` *(as `A.`)* | 1 | 6 |
| `APP._hbaResourceSpec` | `viewer/hba_lens.js:306` *(as `A.`)* | 1 | 6 |
| `APP._hbaRoomFootprint` | `viewer/hba_lens.js:220` *(as `A.`)* | 1 | 4 |
| `APP._hbaRoomMembers` | `viewer/hba_lens.js:232` *(as `A.`)* | 3 | 20 |
| `APP._hbaRooms` | `viewer/hba_lens.js:225` *(as `A.`)* | 2 | 29 |
| `APP._hbaSpaceClass` | `viewer/hba_lens.js:206` *(as `A.`)* | 1 | 2 |
| `APP._hbaStoreyOf` | `viewer/hba_lens.js:225` *(as `A.`)* | 2 | 11 |
| `APP._hbaTenancySpec` | `viewer/hba_lens.js:298` *(as `A.`)* | 2 | 16 |
| `APP._highlightMesh` | `viewer/measure.js:1410` *(as `A.`)* | 1 | 3 |
| `APP._historyOpened` | `viewer/streaming.js:1818` *(as `A.`)* | 1 | 4 |
| `APP._hoverNameState` | `viewer/hover_name.js:172` *(as `A.`)* | 1 | 2 |
| `APP._hrCost` | `viewer/time_machine.js:8726` *(as `app.`)* | 1 | 12 |
...
| `APP._instanceGuids` | `viewer/streaming.js:473` *(as `A.`)* | 2 | 7 |
| `APP._instanceMeta` | `viewer/streaming.js:472` *(as `A.`)* | 2 | 111 |
| `APP._isAuthoredMatName` | `viewer/streaming.js:684` *(as `A.`)* | 1 | 4 |
| `APP._isMobile` | `viewer/streaming.js:474` *(as `A.`)* | 1 | 21 |
...
| `APP._lastPickGuid` | `viewer/picking.js:235` *(as `A.`)* | 5 | 7 |
| `APP._lensflare` | `viewer/scene.js:426` *(as `A.`)* | 1 | 33 |
| `APP._libHasNormals` | `viewer/streaming.js:18` *(as `A.`)* | 5 | 17 |
...
| `APP._loadNightFixtures` | `viewer/tools.js:1277` *(as `A.`)* | 1 | 3 |
...
| `APP._makeDraggable` | `viewer/measure.js:13` *(as `A.`)* | 1 | 19 |
...
| `APP._matCache` | `viewer/streaming.js:471` *(as `A.`)* | 7 | 67 |
| `APP._matNameCol` | `viewer/streaming.js:288` *(as `A.`)* | 6 | 13 |
| `APP._maxqActive` | `viewer/cinema_maxq.js:1053` *(as `A.`)* | 8 | 21 |
...
| `APP._mepDiscAlbedo` | `viewer/streaming.js:721` *(as `A.`)* | 1 | 6 |
| `APP._mepHueClasses` | `viewer/streaming.js:662` *(as `A.`)* | 1 | 10 |
| `APP._mepHueCounts` | `viewer/streaming.js:1207` *(as `A.`)* | 2 | 5 |
| `APP._mepHueOff` | `viewer/tests/witness_mep_color_photoreal.js:179` *(as `A.`)* | 5 | 8 |
...
| `APP._mergeDbIntoScene` | `viewer/scene.js:1050` *(as `A.`)* | 1 | 2 |
...
| `APP._mergeSplitDbIntoScene` | `viewer/scene.js:1167` *(as `A.`)* | 1 | 2 |
| `APP._mergeStreamNext` | `viewer/scene.js:1277` *(as `A.`)* | 1 | 5 |
| `APP._mergedIndex` | `viewer/streaming.js:2011` *(as `A.`)* | 2 | 8 |
| `APP._mergedMeta` | `viewer/streaming.js:2010` *(as `A.`)* | 2 | 15 |
...
| `APP._nightFixtureWorldPositions` | `viewer/tools.js:1665` *(as `A.`)* | 1 | 15 |
...
| `APP._nightLights` | `viewer/tools.js:1062` *(as `A.`)* | 5 | 23 |
| `APP._nightMaxLights` | `viewer/effects.js:2708` *(as `A.`)* | 4 | 12 |
| `APP._nightMaxLightsNav` | `viewer/tools.js:1083` *(as `A.`)* | 1 | 4 |
| `APP._nightMaxLightsStill` | `viewer/tools.js:1087` *(as `A.`)* | 1 | 6 |
| `APP._nightMixAmber` | `viewer/tools.js:1124` *(as `A.`)* | 1 | 2 |
| `APP._nightMixBlue` | `viewer/tools.js:1123` *(as `A.`)* | 1 | 3 |
| `APP._nightMode` | `viewer/tools.js:1061` *(as `A.`)* | 2 | 14 |
| `APP._nightNearFadeFloor` | `viewer/effects.js:2709` *(as `A.`)* | 5 | 15 |
| `APP._nightNearFadeFloorStill` | `viewer/tools.js:1090` *(as `A.`)* | 1 | 8 |
| `APP._nightPLScale` | `viewer/effects.js:2710` *(as `A.`)* | 8 | 24 |
| `APP._nightPLScaleStaged` | `viewer/effects.js:3774` *(as `A.`)* | 5 | 14 |
| `APP._nightPLScaleStill` | `viewer/tools.js:1100` *(as `A.`)* | 1 | 4 |
| `APP._nightSaved` | `viewer/tools.js:1064` *(as `A.`)* | 2 | 27 |
| `APP._nightStars` | `viewer/time_machine.js:2462` *(as `app.`)* | 3 | 14 |
| `APP._nightStillBoost` | `viewer/tools.js:1088` *(as `A.`)* | 1 | 4 |
| `APP._nightUpdateLights` | `viewer/tools.js:1766` *(as `A.`)* | 2 | 16 |
| `APP._nightWindowGlowClasses` | `viewer/tools.js:1548` *(as `A.`)* | 1 | 2 |
| `APP._nlpExecute` | `viewer/nlp.js:589` *(as `A.`)* | 1 | 25 |
...
| `APP._openDbBytes` | `viewer/scene.js:1293` *(as `A.`)* | 1 | 7 |
| `APP._openIfcFiles` | `viewer/scene.js:1355` *(as `A.`)* | 1 | 3 |
| `APP._openIssuesDB` | `viewer/issues.js:9` *(as `A.`)* | 1 | 6 |
| `APP._openJsonEditor` | — *phantom* | 0 | 2 |
| `APP._openSplitDbBytes` | `viewer/scene.js:1322` *(as `A.`)* | 1 | 4 |
...
| `APP._pendingClashStoreys` | `viewer/measure.js:266` *(as `A.`)* | 3 | 6 |
| `APP._pendingInstances` | `viewer/streaming.js:1956` *(as `A.`)* | 3 | 10 |
| `APP._pendingSnagInfo` | `viewer/sitecam.js:215` *(as `A.`)* | 1 | 3 |
| `APP._photoAutoStageOn` | `viewer/effects.js:5376` *(as `A.`)* | 1 | 3 |
| `APP._photoDuskMood` | — *phantom* | 0 | 1 |
| `APP._photoFacadeLightsDbg` | — *phantom* | 0 | 1 |
| `APP._photoFillBase` | `viewer/effects.js:3804` *(as `A.`)* | 2 | 9 |
| `APP._photoGroundAlbedoGain` | `viewer/effects.js:2854` *(as `A.`)* | 1 | 3 |
| `APP._photoMatteSkyEnv` | `viewer/effects.js:2925` *(as `A.`)* | 1 | 3 |
| `APP._photoPaintSeed` | `viewer/effects.js:3633` *(as `A.`)* | 1 | 7 |
...
| `APP._photoStagingOn` | `viewer/effects.js:3327` *(as `A.`)* | 3 | 9 |
| `APP._pickIsolated` | `viewer/picking.js:20` *(as `A.`)* | 2 | 4 |
| `APP._plTopoutWant` | `viewer/effects.js:2734` *(as `A.`)* | 1 | 7 |
| `APP._placePanel` | `viewer/panels.js:264` *(as `A.`)* | 1 | 4 |
...
| `APP._probeAimDepth` | — *phantom* | 0 | 7 |
...
| `APP._refreshGroundBtns` | — *phantom* | 0 | 4 |
...
| `APP._repairDegenerateNormals` | `viewer/streaming.js:1589` *(as `A.`)* | 1 | 1 |
...
| `APP._roleFilterLabel` | `viewer/panels.js:816` *(as `A.`)* | 1 | 3 |
...
| `APP._scrubStop` | `viewer/tour.js:1918` *(as `A.`)* | 1 | 5 |
| `APP._scrubVisible` | `viewer/tour.js:1893` *(as `A.`)* | 1 | 3 |
| `APP._sectionNav` | `viewer/panels.js:669` *(as `A.`)* | 1 | 3 |
| `APP._setBillboardImage` | `viewer/effects.js:2380` *(as `A.`)* | 1 | 1 |
| `APP._setGroundColor` | `viewer/tools.js:155` *(as `A.`)* | 1 | 15 |
| `APP._setGroundWetness` | `viewer/effects.js:3408` *(as `A.`)* | 1 | 4 |
| `APP._setRuleChecklistCategory` | `viewer/rule_checklist.js:434` *(as `A.`)* | 1 | 4 |
| `APP._setTreeMode` | — *phantom* | 0 | 2 |
| `APP._shadowGroundKey` | `viewer/tools.js:924` *(as `A.`)* | 2 | 6 |
| `APP._shadowInited` | `viewer/effects.js:3074` *(as `A.`)* | 2 | 4 |
| `APP._shadowOn` | `viewer/tools.js:923` *(as `A.`)* | 2 | 26 |
...
| `APP._solidMeshes` | `viewer/effects.js:1099` *(as `A.`)* | 1 | 6 |
| `APP._splitHasMeta` | `viewer/streaming.js:3078` *(as `A.`)* | 4 | 7 |
| `APP._ssaoPass` | `viewer/effects.js:11` *(as `A.`)* | 2 | 15 |
| `APP._ssgiActive` | `viewer/effects_gi_poc.js:140` *(as `A.`)* | 4 | 17 |
...
| `APP._stillBudget` | `viewer/cinema_maxq.js:538` | 3 | 9 |
| `APP._stillRefineActive` | `viewer/effects.js:122` *(as `A.`)* | 8 | 54 |
| `APP._stillRefineBusy` | `viewer/effects.js:4400` *(as `A.`)* | 7 | 26 |
| `APP._stillSSGIEnabled` | `viewer/effects_gi_poc.js:541` *(as `A.`)* | 1 | 2 |
...
| `APP._sunArcFillPin` | `viewer/effects.js:2733` *(as `A.`)* | 2 | 8 |
| `APP._sunArcStep` | `viewer/effects.js:2653` *(as `A.`)* | 1 | 7 |
| `APP._sunCycleActive` | `viewer/time_machine.js:2375` *(as `app.`)* | 3 | 4 |
| `APP._sunShadowRestoreEnabled` | `viewer/effects.js:4364` *(as `A.`)* | 1 | 3 |
...
| `APP._taaPass` | `viewer/effects.js:96` *(as `A.`)* | 1 | 19 |
...
| `APP._tmIsVisible` | `viewer/effects.js:2511` *(as `A.`)* | 2 | 10 |
| `APP._tmOn` | `viewer/time_machine.js:8831` *(as `app.`)* | 2 | 14 |
...
| `APP._tmVisSubscribe` | `viewer/effects.js:2508` *(as `A.`)* | 1 | 3 |
...
| `APP._tourCachedRoute` | `viewer/tour.js:91` *(as `A.`)* | 2 | 7 |
| `APP._tourPaused` | `viewer/tour.js:357` *(as `A.`)* | 3 | 16 |
| `APP._tourPrepare` | `viewer/tour.js:1414` *(as `A.`)* | 1 | 2 |
| `APP._tourStarts` | `viewer/tour.js:1419` *(as `A.`)* | 1 | 27 |
| `APP._tourStoreyZ` | `viewer/tour.js:451` *(as `A.`)* | 1 | 3 |
| `APP._tourT` | `viewer/tour.js:1431` *(as `A.`)* | 4 | 21 |
| `APP._tourTotal` | `viewer/tour.js:1430` *(as `A.`)* | 1 | 26 |
| `APP._triNormalOff` | `witness_triplanar_normal.js:47` | 1 | 2 |
...
| `APP._visibilityGen` | `viewer/panels.js:732` *(as `A.`)* | 3 | 7 |
...
| `APP._whiteBg` | `viewer/tools.js:1035` *(as `A.`)* | 2 | 10 |
| `APP._winCtx` | `erp/idempiere.html:3856` | 1 | 1 |
...
| `APP.activeBuilding` | `viewer/city.js:788` *(as `A.`)* | 9 | 227 |
| `APP.activeBuildingTotal` | `viewer/city.js:789` *(as `A.`)* | 9 | 20 |
| `APP.activeGuidFilter` | `viewer/panels.js:847` *(as `A.`)* | 1 | 10 |
| `APP.activeStoreyFilter` | `viewer/main.js:1114` | 4 | 30 |
| `APP.actor` | `erp/idempiere.html:1186` | 2 | 11 |
...
| `APP.allRoomVolumes` | `viewer/navigate_find.js:2293` *(as `A.`)* | 1 | 4 |
| `APP.ambient` | `viewer/scene.js:190` *(as `A.`)* | 1 | 40 |
...
| `APP.bigStatsAt` | `viewer/cpe_resource_panel.js:486` *(as `A.`)* | 1 | 3 |
| `APP.bigStatsAtSpan` | `viewer/cpe_resource_panel.js:474` *(as `A.`)* | 1 | 3 |
| `APP.bigStatsBuild` | `viewer/cpe_resource_panel.js:244` *(as `A.`)* | 1 | 9 |
| `APP.bigStatsCompositeOntoCanvas` | `viewer/cpe_resource_panel.js:555` *(as `A.`)* | 1 | 4 |
| `APP.blobToGeometry` | `viewer/scene.js:1883` *(as `A.`)* | 1 | 7 |
...
| `APP.buildRuleDeepLink` | `viewer/rule_checklist.js:544` *(as `A.`)* | 1 | 3 |
| `APP.buildShareUrl` | `viewer/share.js:211` *(as `A.`)* | 1 | 5 |
...
| `APP.buildingCentres` | `viewer/scene.js:452` *(as `A.`)* | 1 | 99 |
...
| `APP.buildingName` | — *phantom* | 0 | 4 |
| `APP.buildingsRendered` | `viewer/scene.js:461` *(as `A.`)* | 1 | 60 |
| `APP.buildupCursorAt` | `viewer/cinema_maxq.js:2377` | 1 | 31 |
| `APP.buildupPacingReset` | `viewer/cinema_maxq.js:2382` | 1 | 19 |
| `APP.buildupTAt` | `viewer/cinema_maxq.js:2380` | 1 | 23 |
| `APP.buildupTopoutU` | `viewer/cinema_maxq.js:2381` | 1 | 9 |
| `APP.cacheStoreyLevels` | `viewer/walk.js:243` *(as `A.`)* | 1 | 2 |
| `APP.cachedFetch` | `viewer/scene.js:1487` *(as `A.`)* | 1 | 22 |
| `APP.camera` | `viewer/grid_views.js:83` *(as `A.`)* | 4 | 807 |
| `APP.cancelMaxQualityOrbit` | `viewer/cinema_maxq.js:2372` | 1 | 4 |
| `APP.cancelWalkAnchor` | `viewer/walk.js:33` *(as `A.`)* | 1 | 2 |
| `APP.canvas` | `viewer/scene.js:10` *(as `A.`)* | 1 | 54 |
...
| `APP.cinemaPathEditor` | `viewer/cinema_path_editor.js:3886` | 1 | 148 |
| `APP.cinemaPathPlan` | `viewer/effects.js:9267` *(as `A.`)* | 1 | 185 |
| `APP.cinemaPathPlanDerived` | `viewer/effects.js:9307` *(as `A.`)* | 1 | 2 |
| `APP.cinemaPrefixInvalidate` | `viewer/effects.js:9262` *(as `A.`)* | 1 | 3 |
...
| `APP.cityBuildingDbs` | `viewer/city.js:11` *(as `A.`)* | 3 | 15 |
| `APP.cityClear` | `viewer/city.js:806` *(as `A.`)* | 1 | 1 |
| `APP.cityDb` | `viewer/city.js:8` *(as `A.`)* | 2 | 13 |
| `APP.cityLoadBuilding` | `viewer/city.js:641` *(as `A.`)* | 1 | 3 |
| `APP.citySQL` | `viewer/city.js:9` *(as `A.`)* | 2 | 9 |
| `APP.clashFilm` | `viewer/clash_film.js:91` *(as `A.`)* | 1 | 121 |
...
| `APP.clashNarrow` | `viewer/clash_narrow.js:447` *(as `A.`)* | 1 | 47 |
...
| `APP.clearHighlight` | `viewer/navigate_find.js:5030` *(as `A.`)* | 1 | 1 |
| `APP.clearMeasures` | `viewer/measure.js:1212` *(as `A.`)* | 1 | 3 |
| `APP.clearRouteCache` | — *phantom* | 0 | 2 |
| `APP.clearStreamed` | `viewer/streaming.js:3456` *(as `A.`)* | 1 | 3 |
| `APP.clientId` | `erp/idempiere.html:1187` | 1 | 4 |
| `APP.closeFindPanel` | `viewer/navigate_find.js:4330` *(as `A.`)* | 1 | 3 |
...
| `APP.collectMeshes` | `viewer/helpers.js:20` *(as `A.`)* | 1 | 101 |
| `APP.composeGhostsFromAggregates` | — *phantom* | 0 | 4 |
...
| `APP.controls` | `viewer/scene.js:164` *(as `A.`)* | 2 | 505 |
| `APP.cpeRevealApplyVisual` | `viewer/effects.js:5995` *(as `A.`)* | 1 | 7 |
| `APP.cpeRevealCaptionAt` | `viewer/effects.js:5953` *(as `A.`)* | 1 | 6 |
| `APP.cpeRevealDiscLabel` | `viewer/effects.js:5916` *(as `A.`)* | 1 | 10 |
| `APP.cpeRevealDiscQtyCost` | `viewer/effects.js:5929` *(as `A.`)* | 1 | 6 |
| `APP.cpeRevealDiscsPresent` | `viewer/effects.js:5802` *(as `A.`)* | 1 | 6 |
| `APP.cpeRevealLightsOffAt` | `viewer/effects.js:5991` *(as `A.`)* | 1 | 3 |
| `APP.cpeRevealVisualAt` | `viewer/effects.js:5876` *(as `A.`)* | 1 | 9 |
| `APP.createPanel` | `viewer/panels.js:209` *(as `A.`)* | 1 | 1 |
| `APP.createSnag` | `viewer/helpers.js:515` *(as `A.`)* | 1 | 3 |
| `APP.currentBuilding` | — *phantom* | 0 | 5 |
| `APP.cycleRoleFilter` | `viewer/panels.js:806` *(as `A.`)* | 1 | 3 |
| `APP.cycleWalkSpeed` | `viewer/tour.js:1103` *(as `A.`)* | 1 | 2 |
| `APP.cycleXrayBboxMode` | `viewer/tools.js:375` *(as `A.`)* | 1 | 3 |
| `APP.dayCounterAt` | `viewer/cpe_day_counter.js:32` *(as `A.`)* | 1 | 20 |
...
| `APP.db` | `viewer/city.js:712` *(as `A.`)* | 12 | 551 |
| `APP.dbQuery` | `viewer/helpers.js:116` *(as `A.`)* | 1 | 537 |
| `APP.dbQueryFirst` | `viewer/helpers.js:130` *(as `A.`)* | 1 | 11 |
| `APP.deleteImported` | `viewer/import.js:591` *(as `A.`)* | 1 | 4 |
| `APP.diffDb` | `viewer/main.js:980` | 1 | 18 |
| `APP.diffResult` | `viewer/diff.js:47` *(as `A.`)* | 1 | 32 |
...
| `APP.dlodTick` | `viewer/dlod.js:137` *(as `A.`)* | 1 | 17 |
...
| `APP.ensureRooms` | `viewer/navigate_find.js:937` *(as `A.`)* | 1 | 80 |
| `APP.erpQuery` | `viewer/hba_lens.js:349` *(as `A.`)* | 1 | 3 |
| `APP.exitRuleModeTint` | `viewer/rule_checklist.js:520` *(as `A.`)* | 1 | 2 |
| `APP.export4D5D` | `viewer/tools.js:493` *(as `A.`)* | 1 | 4 |
| `APP.exportIFC` | `viewer/import.js:677` *(as `A.`)* | 1 | 5 |
| `APP.exportIssuesExcel` | `viewer/excel.js:16` *(as `A.`)* | 1 | 2 |
| `APP.filterBatchedMesh` | `viewer/helpers.js:62` *(as `A.`)* | 1 | 4 |
| `APP.filterByGuids` | `viewer/panels.js:846` *(as `A.`)* | 1 | 40 |
| `APP.filterDisc` | `viewer/panels.js:751` *(as `A.`)* | 1 | 19 |
| `APP.filterDiscs` | `viewer/panels.js:756` *(as `A.`)* | 1 | 7 |
| `APP.filterInstancedMesh` | `viewer/helpers.js:36` *(as `A.`)* | 1 | 5 |
| `APP.filterMergedMesh` | `viewer/helpers.js:85` *(as `A.`)* | 1 | 2 |
| `APP.filterStorey` | `viewer/panels.js:716` *(as `A.`)* | 1 | 24 |
| `APP.findMainEntrance` | `viewer/navigate_find.js:5032` *(as `A.`)* | 1 | 1 |
| `APP.findMeshByGuid` | `viewer/walk.js:577` *(as `A.`)* | 1 | 3 |
| `APP.findNearestDoorPosition` | `viewer/walk.js:199` *(as `A.`)* | 1 | 2 |
| `APP.flyActive` | `viewer/picking.js:71` *(as `A.`)* | 14 | 48 |
...
| `APP.flyTargets` | `viewer/picking.js:73` *(as `A.`)* | 2 | 11 |
...
| `APP.flythruDatumFigures` | `viewer/cpe_flythru_datum.js:753` *(as `A.`)* | 1 | 5 |
...
| `APP.flythruFrameMap` | `viewer/cpe_flythru_dims.js:291` *(as `A.`)* | 1 | 4 |
| `APP.flythruGapsAlong` | `viewer/cpe_flythru_dims.js:695` *(as `A.`)* | 1 | 7 |
| `APP.flythruGate` | `viewer/cpe_flythru_dims.js:594` *(as `A.`)* | 1 | 10 |
...
| `APP.focusElement` | `viewer/navigate_find.js:5044` *(as `A.`)* | 1 | 12 |
| `APP.friendlyName` | `viewer/navigate_find.js:5033` *(as `A.`)* | 1 | 14 |
| `APP.gateRecordFor` | `erp/idempiere.html:1193` | 1 | 1 |
| `APP.gazeAcquireCap` | `viewer/effects.js:6464` *(as `A.`)* | 1 | 6 |
| `APP.gazeAcquireStep` | `viewer/effects.js:6465` *(as `A.`)* | 1 | 3 |
| `APP.generateQR` | `viewer/helpers.js:391` *(as `A.`)* | 1 | 4 |
| `APP.getDiffDetail` | `viewer/diff.js:168` *(as `A.`)* | 1 | 1 |
| `APP.getRoomGraph` | `viewer/navigate_find.js:1237` *(as `A.`)* | 1 | 27 |
...
| `APP.ground` | `viewer/scene.js:441` *(as `A.`)* | 1 | 129 |
| `APP.groundIfcZ` | `viewer/tools.js:88` *(as `A.`)* | 1 | 8 |
| `APP.guidMap` | `viewer/city.js:822` *(as `A.`)* | 4 | 183 |
...
| `APP.hemi` | `viewer/scene.js:200` *(as `A.`)* | 1 | 38 |
...
| `APP.icon` | `viewer/panels.js:182` *(as `A.`)* | 1 | 15 |
| `APP.ifc2three` | `viewer/scene.js:499` *(as `A.`)* | 2 | 287 |
...
| `APP.importMultiIFC` | `viewer/import.js:267` *(as `A.`)* | 1 | 5 |
...
| `APP.init` | `viewer/streaming.js:2925` *(as `A.`)* | 1 | 2 |
| `APP.initCity` | `viewer/city.js:314` *(as `A.`)* | 1 | 3 |
| `APP.inputWasVoice` | `viewer/navigate_find.js:4157` *(as `A.`)* | 6 | 8 |
...
| `APP.libDb` | `viewer/city.js:713` *(as `A.`)* | 12 | 59 |
...
| `APP.linearBeatReport` | `viewer/cpe_linear_beat.js:190` *(as `A.`)* | 1 | 3 |
| `APP.listRooms` | `viewer/panels.js:875` *(as `A.`)* | 1 | 2 |
| `APP.loadCityManual` | `viewer/city.js:306` *(as `A.`)* | 1 | 1 |
| `APP.loadFromHash` | `viewer/streaming.js:3447` *(as `A.`)* | 1 | 2 |
| `APP.loadNavigate` | `viewer/main.js:126` | 1 | 107 |
| `APP.loadWizard` | `viewer/main.js:233` | 1 | 2 |
| `APP.markDirty` | `viewer/effects.js:4371` *(as `A.`)* | 4 | 329 |
| `APP.materializeZones` | — *phantom* | 0 | 2 |
| `APP.maxqStatusDayRoomSegs` | `viewer/cinema_maxq.js:2396` | 1 | 13 |
| `APP.measureActive` | `viewer/main.js:1060` | 3 | 26 |
...
| `APP.measureLabels` | `viewer/measure.js:1221` *(as `A.`)* | 3 | 22 |
| `APP.mepSmoothNormals` | `viewer/streaming.js:84` *(as `A.`)* | 1 | 9 |
| `APP.meshCache` | `viewer/scene.js:454` *(as `A.`)* | 2 | 34 |
| `APP.modelOffset` | `viewer/scene.js:458` *(as `A.`)* | 1 | 63 |
...
| `APP.nightLightColor` | `viewer/tools.js:1151` *(as `A.`)* | 1 | 5 |
| `APP.nightLightIntensityMult` | `viewer/tools.js:1205` *(as `A.`)* | 1 | 2 |
| `APP.onSectionOff` | — *phantom* | 0 | 2 |
| `APP.onSectionSliderChange` | — *phantom* | 0 | 2 |
| `APP.openCacheDB` | `viewer/scene.js:582` *(as `A.`)* | 1 | 28 |
| `APP.openFindPanel` | `viewer/main.js:230` | 2 | 56 |
| `APP.openImported` | `viewer/import.js:533` *(as `A.`)* | 1 | 9 |
| `APP.openModelDb` | `viewer/scene.js:1382` *(as `A.`)* | 1 | 11 |
...
| `APP.renderer` | `viewer/scene.js:123` *(as `A.`)* | 1 | 343 |
| `APP.reportBug` | `viewer/helpers.js:204` *(as `A.`)* | 1 | 6 |
| `APP.reportError` | `viewer/error_reporter.js:112` *(as `A.`)* | 2 | 10 |
...
| `APP.resourcePanelHoldAt` | `viewer/cpe_resource_panel.js:144` *(as `A.`)* | 1 | 3 |
...
| `APP.roomTitleApplyHold` | `viewer/cpe_room_title.js:763` *(as `A.`)* | 1 | 10 |
| `APP.roomTitleApplyLead` | `viewer/cpe_room_title.js:711` *(as `A.`)* | 1 | 12 |
| `APP.roomTitleBuildTimeline` | `viewer/cpe_room_title.js:444` *(as `A.`)* | 1 | 18 |
| `APP.roomTitleCompositeOntoCanvas` | `viewer/cpe_room_title.js:816` *(as `A.`)* | 1 | 14 |
...
| `APP.sectionOn` | `viewer/section_cut.js:834` | 6 | 18 |
...
| `APP.shareUrl` | `viewer/share.js:294` *(as `A.`)* | 1 | 5 |
| `APP.showCommandPalette` | `viewer/scene.js:2647` *(as `A.`)* | 1 | 1 |
| `APP.showDiffSummary` | `viewer/diff.js:293` *(as `A.`)* | 1 | 2 |
| `APP.showEgressSanity` | `viewer/rule_checklist.js:673` *(as `A.`)* | 1 | 2 |
| `APP.showQRShare` | `viewer/helpers.js:420` *(as `A.`)* | 1 | 5 |
| `APP.showRuleChecklist` | `viewer/rule_checklist.js:427` *(as `A.`)* | 1 | 3 |
| `APP.showRuleModeTint` | `viewer/rule_checklist.js:449` *(as `A.`)* | 1 | 3 |
| `APP.showStructuralSanity` | `viewer/rule_checklist.js:622` *(as `A.`)* | 1 | 2 |
| `APP.sky` | — *phantom* | 0 | 10 |
| `APP.slabBeatAt` | `viewer/cpe_slab_beat.js:419` *(as `A.`)* | 1 | 4 |
| `APP.slabBeatBuild` | `viewer/cpe_slab_beat.js:156` *(as `A.`)* | 1 | 8 |
| `APP.slabBeatClock` | `viewer/cpe_slab_beat.js:449` *(as `A.`)* | 1 | 5 |
| `APP.slabBeatDispose` | `viewer/cpe_slab_beat.js:450` *(as `A.`)* | 1 | 5 |
| `APP.slabBeatReport` | `viewer/cpe_slab_beat.js:448` *(as `A.`)* | 1 | 5 |
| `APP.snapSitePhoto` | `viewer/sitecam.js:204` *(as `A.`)* | 1 | 2 |
| `APP.softStopStillRefine` | `viewer/effects.js:5427` *(as `A.`)* | 1 | 5 |
| `APP.stageCinemaPath` | `viewer/effects.js:9202` *(as `A.`)* | 1 | 2 |
| `APP.startCinemaOrbit` | `viewer/effects.js:9341` *(as `A.`)* | 1 | 8 |
| `APP.startDriveThru` | `viewer/walk.js:396` *(as `A.`)* | 1 | 7 |
| `APP.startFlyTour` | — *phantom* | 0 | 2 |
| `APP.startMaxQ` | — *phantom* | 0 | 2 |
| `APP.startMaxQualityOrbit` | `viewer/cinema_maxq.js:2371` | 1 | 80 |
| `APP.startNavigation` | — *phantom* | 0 | 3 |
| `APP.startOfflineDownload` | `viewer/scene.js:3041` *(as `A.`)* | 1 | 1 |
| `APP.startStepDetection` | `viewer/walk.js:354` *(as `A.`)* | 1 | 1 |
| `APP.startStillRefine` | `viewer/effects.js:5138` *(as `A.`)* | 1 | 56 |
...
| `APP.storeyRevealStatCardAt` | `viewer/cpe_storey_reveal.js:209` *(as `A.`)* | 1 | 5 |
| `APP.storeyRevealStatsFor` | `viewer/cpe_storey_reveal.js:93` *(as `A.`)* | 1 | 5 |
| `APP.storeyRevealVisualAt` | `viewer/cpe_storey_reveal.js:163` *(as `A.`)* | 1 | 4 |
| `APP.streamBuilding` | `viewer/streaming.js:318` *(as `A.`)* | 1 | 29 |
| `APP.streamIdx` | `viewer/city.js:786` *(as `A.`)* | 10 | 58 |
| `APP.streamQueue` | `viewer/city.js:777` *(as `A.`)* | 12 | 87 |
| `APP.streamTick` | `viewer/streaming.js:1683` *(as `A.`)* | 1 | 2 |
| `APP.streamedCount` | `viewer/city.js:820` *(as `A.`)* | 5 | 40 |
| `APP.streaming` | `viewer/city.js:787` *(as `A.`)* | 15 | 134 |
| `APP.sun` | `viewer/scene.js:196` *(as `A.`)* | 1 | 189 |
| `APP.sunglassOn` | `viewer/tools.js:574` *(as `A.`)* | 2 | 2 |
| `APP.tailPanelAt` | `viewer/cpe_resource_panel.js:543` *(as `A.`)* | 1 | 4 |
| `APP.three2ifc` | `viewer/scene.js:506` *(as `A.`)* | 1 | 30 |
...
| `APP.toggleGridOverlay` | — *phantom* | 0 | 25 |
| `APP.toggleHoverName` | `viewer/hover_name.js:149` *(as `A.`)* | 1 | 8 |
| `APP.toggleIssues` | `viewer/issues.js:243` *(as `A.`)* | 1 | 2 |
| `APP.toggleMeasure` | `viewer/measure.js:1177` *(as `A.`)* | 1 | 6 |
| `APP.toggleNightMode` | `viewer/tools.js:1465` *(as `A.`)* | 1 | 19 |
| `APP.toggleNlp` | `viewer/nlp.js:672` *(as `A.`)* | 1 | 9 |
| `APP.togglePanel` | `viewer/panels.js:494` *(as `A.`)* | 1 | 2 |
| `APP.togglePopulate` | `viewer/effects.js:2141` *(as `A.`)* | 1 | 17 |
| `APP.toggleSSAO` | `viewer/effects.js:19` *(as `A.`)* | 2 | 6 |
| `APP.toggleSSGIPreview` | `viewer/effects_gi_poc.js:487` *(as `A.`)* | 1 | 7 |
| `APP.toggleSection` | `viewer/tools.js:402` *(as `A.`)* | 1 | 8 |
| `APP.toggleShadow` | `viewer/tools.js:930` *(as `A.`)* | 1 | 8 |
...
| `APP.updateSky` | `viewer/scene.js:253` *(as `A.`)* | 1 | 13 |
| `APP.viewer` | — *phantom* | 0 | 2 |
| `APP.walkActionIdx` | `viewer/picking.js:82` *(as `A.`)* | 9 | 42 |
...
| `APP.walkMode` | `viewer/picking.js:46` *(as `A.`)* | 13 | 32 |
| `APP.walkModeActive` | `viewer/navigate_find.js:4234` *(as `A.`)* | 4 | 45 |
...
| `APP.xrayOn` | `viewer/tools.js:305` *(as `A.`)* | 4 | 55 |
| `APP.zoomToGuid` | `viewer/diff.js:187` *(as `A.`)* | 1 | 9 |
| `APP.zoomToGuids` | `viewer/diff.js:241` *(as `A.`)* | 1 | 3 |
