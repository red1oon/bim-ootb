...
function setupPanels(A) {
  ...
  (function() {
    ...
    var _actions = [
      ...
      { id: 'help',       name: 'Help',            key: 'F1', icon: I.lifeBuoy.svg, fn: function() { if (window.AboutDIY) AboutDIY.open(); else if (typeof showCommandPalette === 'function') showCommandPalette(); } },
