-- ════════════════════════════════════════════════════════
-- KUL001: add the missing elements_meta.building column to buildings/KUL_CONTAINMENT_extracted.db
--
-- Issue this patch proves/disproves: the KUL DBs load (§DB_LOADED size=38MB) but render ZERO
