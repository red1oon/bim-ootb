...
(function() {
  ...
  function _capturePanelState(ov) {
    ...
    return {
      checkboxes: { buildup: !!ov.buildup, roomTitle: !!ov.roomTitle, reveal: !!ov.reveal, clash: !!ov.clash, measure: !!ov.measure,
                    storeyReveal: !!ov.storeyReveal, escapeRoute: !!ov.escapeRoute,
                    sunCompass: !!ov.sunCompass },
      sunDate: ov.sunDate || '',
      bakeRes: ov.bakeRes || '',
  ...
  function _syncPanelControls() {
    [['cpe-buildup', !!_state.buildup], ['cpe-room-title', !!_state.roomTitle],
     ...
     ['cpe-storey-reveal', !!_state.storeyReveal], ['cpe-escape-route', !!_state.escapeRoute],
