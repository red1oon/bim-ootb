...
async function initViewer() {
  ...
  var _mods = [setupHelpers, setupStreaming, setupPanels, setupTools,
    setupPicking, setupHoverName, setupCpeRoomTitle, setupCpeDayCounter, setupCpePathOverview, setupCpeResourcePanel, setupCpeStoreyReveal, setupCpeEscapeRoute, setupCpeFlythruDims, setupCpeFlythruCues, setupCpeFlythruDatum, setupSunPath, setupCpeSunCompass, setupCpeSlabBeat, setupCpeLinearBeat, setupCpeIndoorBeats, setupTour, setupMeasure, setupSitecam, setupShare, setupIssues, setupExcel, setupWalk, setupCity];
