...
async function initViewer() {
  ...
  var _mods = [setupHelpers, setupStreaming, setupPanels, setupTools,
    setupPicking, setupHoverName, setupCpeRoomTitle, setupCpeDayCounter, setupCpePathOverview, setupCpeResourcePanel, setupCpeStoreyReveal, setupCpeFlythruDims, setupCpeFlythruCues, setupTour, setupMeasure, setupSitecam, setupShare, setupIssues, setupExcel, setupWalk, setupCity];
