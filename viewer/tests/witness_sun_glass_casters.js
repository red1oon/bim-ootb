...
(async () => {
  ...
  for (const bld of LIST.split(',')) {
    ...
    const r = await p.evaluate(() => {
      ...
      const out = { meshes: 0, instances: 0, glassM2: 0, byClass: {}, r10Exempt: 0, sunCastShadow: !!(A.sun && A.sun.castShadow) };
      ...
      A.scene.traverse(o => {
        ...
        out.meshes++; o.updateMatrixWorld();
      ...
      Object.values(out.byClass).forEach(e => { e.m2 = Math.round(e.m2); }); out.glassM2 = Math.round(out.glassM2); return out; });
