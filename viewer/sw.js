...
// v1016 (2026-08-13) §TIER2_PER_ELEMENT_CLAMP + §SHIFT_HOURS: 4D schedule generation changed
...
// Collided TWICE, independent same-day bumps, neither with a dedicated comment here (see their
// commit messages): #1331 v1013->v1014 (N8AO retune) and #1332 v1014->v1015 (SW precache
// cache.add->fetch+put fix, itself a re-bump because #1331's v1014 didn't reliably reach browsers
// that had the old effects.js in HTTP cache) — took one past the higher per this file's own
// KEEP-BOTH/take-the-higher merge convention.
