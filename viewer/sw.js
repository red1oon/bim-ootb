...
const CACHE_VERSION = 'v1264';   // bump on each deploy; per-change detail is the git commit message.
...
const PRECACHE_ASSETS = [
  ...
  'surface_r10.js',
  'sky_portal.js',   // §SKY_PORTAL: Alt+S window panes as sky light sources
  'loader.js',
  'effects.js',
  'cinema_maxq.js',
