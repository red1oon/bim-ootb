...
const DUR = 24, FPS = 24, T0 = 10, NFRAMES = 240;
const OUT = path.join(__dirname, 'out', 'poses_hhs_t10_20.json');
(async () => {
  ...
  console.log('§HHS_SEQ_POSES frames=' + poses.length + ' first=' + JSON.stringify(poses[0]) + ' last=' + JSON.stringify(poses[poses.length - 1]) + ' savedTo=' + OUT);
