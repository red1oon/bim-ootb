// PATCHED COPY (2026-09-22, sandbox spike): only change from ../utils/TAAUtils.js is the 'three/tsl' bare-specifier import rewritten to the direct-path three.tsl.direct.js — no import map needed. See gi_webgpu_tap.js.
import { add, float, Fn, If, luminance, max, struct, vec2, vec4, getViewPosition, logarithmicDepthToViewZ, viewZToOrthographicDepth, viewZToPerspectiveDepth } from '../vendor/r186/three.tsl.direct.js';
