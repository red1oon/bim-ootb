...
const CACHE_VERSION = 'v592';   // v592: §D RED PILL — "just the pill" (our clean design, default) ⟷ classic iDempiere L&F toggle (key ','); scrubber dots-only (dropped ↶/↷ for pill-icon consistency); arrow-key record nav;
