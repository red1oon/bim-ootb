...
await page.waitForFunction(()=>document.querySelector('.dash-card'),{timeout:10000}).catch(()=>{});
await page.waitForTimeout(900);
const ov=await page.evaluate(()=>({charts:document.querySelectorAll('.dash-chart').length,bars:document.querySelectorAll('.dash-gbox .chart-bar, .dash-gbox .donut-svg').length,chips:document.querySelectorAll('.ask-chip').length}));
