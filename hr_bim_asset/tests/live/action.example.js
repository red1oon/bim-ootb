...
// tint occupancy and count meshes that actually changed emissive
HBALens.toggle(A,'occupancy');
var tinted=A.collectMeshes(function(o){return o.isMesh;}).filter(function(m){try{return m.material&&m.material.emissive&&m.material.emissive.getHex()!==0;}catch(e){return false;}}).length;
console.log('§DIAG2 afterOccupancyToggle activeOcc='+HBALens.isActive('occupancy')+' tintedMeshes='+tinted);
